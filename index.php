...
<body>
	...
	<div class="info" alt="traseul, ruta, drumul, orase">
			...
			<h2>Zilnic la 18:00</h2>
			<div class="container">
				<div class="phone_header prime"><a href="callto://+37376004389">+373 76004389</a></div>
				<div class="phonering_header prime"><a href="callto://+37376004389" style="padding-right: 0px !important;">+373 76004389</a></div>
				<h3>Bârlad, Focșani, Buzău, Ploiești<br>și Aeroportul Otopeni</h3>
		</div>
	</section>
	...
	<section class="description">
		<div class="description_container">
			<div class="pasageri">
				...
				<p class="pinfo">Organizăm transport zilnic la București la ora 18:00. La fel este posibila arendarea rutei spre alte destinatii in Romania.</p>
			</div>
			<div class="colete">
					<div class="gif_container">
